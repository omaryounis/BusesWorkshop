<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/Master.Master" CodeBehind="District.aspx.cs" Inherits="BusesWorkshop.Pages.District" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SupPlaceHolder" runat="server">
    <div class="row">
     ...
     <div class="row">
                ...
                <div class="form-horizontal">
                 <div class="form-group col-md-6">
                        <label class="col-md-3 control-label">
                            <asp:Label ID="Label2" runat="server" Text="اسم الحى"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="Save"
                                Display="Dynamic" ErrorMessage="*" ControlToValidate="txt_DistrictName"></asp:RequiredFieldValidator>
                        </label>
                        <div class="col-md-9">
                            <asp:TextBox CssClass="form-control" ID="txt_DistrictName" runat="server"></asp:TextBox>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card-box">
                <asp:GridView ID="gvdistrict" CssClass="table m-0 table-colored table-danger" runat="server"
