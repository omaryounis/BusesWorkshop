...
{
    public partial class MaintRequest : System.Web.UI.Page
    {
        #region "Properties" 
        DataTable dt;
        DataTable DtDisplay;
        ...
        private void Fillddl_WorkId(string RadioIsAssetValue) {
            ...
            {
                ddl_WorkId.DataSource = dcWorkShop.ConfigDetails.Where(x => x.MasterId == 18 && x.RecType == 0 || x.RecType == 2
                ).Select(x => new { x.ConfigDetailId, x.ConfigDetailName }).ToList();
            }
