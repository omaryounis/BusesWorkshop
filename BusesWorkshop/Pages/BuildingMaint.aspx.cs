...
//{
//    public partial class BuildingMaint : System.Web.UI.Page
//    {
//        #region "Properties"
//        DataTable dt;
...
//            try
//            {
//                DataTable dt = Common.GetUserPermission(dc, int.Parse(Session["UserID"].ToString()), Common.PagesEnum.BuildingMaint.GetHashCode());
//                if (dt.Rows.Count > 0)
//                {
...
//        {
//            Page.Title = "الصيانة الطارئة للمبانى";
//            permissions(dc);
...
//                DataColumn dc3 = new DataColumn("MaterialCost");
//                DataColumn dc4 = new DataColumn("MaterialCount");
//                DataColumn dc5 = new DataColumn("MaterialTotal");
//                DataColumn dc6 = new DataColumn("LabourCost");
...
//            #region save
//            int Result = 0;
//            DAL.Bus.BuildingMaint _BuildingMaint = new DAL.Bus.BuildingMaint();

//            _BuildingMaint.BuildingId = int.Parse(ddl_BuildingId.SelectedItem.Value.ToString());
//            _BuildingMaint.WorkId = int.Parse(ddl_WorkId.SelectedItem.Value.ToString());
//            _BuildingMaint.MaintDate = DateTime.Parse(txt_MaintDate.Text);
//            _BuildingMaint.Defect = txt_Defects.Text;
//            _BuildingMaint.Procedure = txt_Prodedures.Text;
//            _BuildingMaint.Notes = txtNotes.Text;
//            dc.BuildingMaints.InsertOnSubmit(_BuildingMaint);
//            dc.SubmitChanges();
//            Result = _BuildingMaint.BuildingMaintId;
//            #endregion
...
//                {
//                    BuildingMaintDetail _BuildingMaintDetail = new BuildingMaintDetail();
//                    _BuildingMaintDetail.BuildingMaintId = Result;
//                    _BuildingMaintDetail.MaterialId = int.Parse(ddl_MaterialId.SelectedItem.Value.ToString());
//                    _BuildingMaintDetail.MaterialCost = decimal.Parse(txt_MaterialCost.Text);
//                    _BuildingMaintDetail.MaterialCount = decimal.Parse(txt_MaterialTotal.Text);
//                    _BuildingMaintDetail.MaterialTotal = decimal.Parse(txt_MaterialTotal.Text);
//                    _BuildingMaintDetail.LabourCost = decimal.Parse(txt_MaterialCost.Text);
//                    _BuildingMaintDetail.TotalCost = decimal.Parse(txt_TotalCost.Text);

//                    ctx.BuildingMaintDetails.InsertOnSubmit(_BuildingMaintDetail);
//                    ctx.SubmitChanges();
...
//        protected void ddl_MaterialMainId_SelectedIndexChanged(object sender, EventArgs e)
//        {
...
//                                             where p.CategoryId == int.Parse(ddl_MaterialMainId.SelectedItem.Value.ToString())   select new { p.MaterialId, p.MaterialName};
...
//            dr1[2] = txt_MaterialCost.Text;
//            dr1[3] = txt_MaterialCount.Text;
//            dr1[4] = txt_MaterialTotal.Text;
...
//                    ddl_MaterialId.DataSource = from p in dc.Materials where p.CategoryId == int.Parse(ddl_MaterialMainId.SelectedItem.Value.ToString()) select  new {p.MaterialId , p.MaterialName};
//ddl_MaterialId.TextField ="MaterialName";
//                    ddl_MaterialId.ValueField = "MaterialId";
//                    ddl_MaterialId.DataBind();
