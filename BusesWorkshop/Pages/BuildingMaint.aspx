<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Master.Master" CodeBehind="BuildingMaint.aspx.cs" Inherits="BusesWorkshop.Pages.BuildingMaint" %>
...
$(function() {
    ...
    $('[id*=txt_MaintDate]').calendarsPicker({ calendar: calendar });
    });
...
<div class="form-group col-md-6">
                        <label class="col-md-3 control-label">
                            <asp:Label ID="Label2" runat="server" Text="اسم العمل"></asp:Label>
                        </label>
                        <div class="col-md-9">
 ...
 <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ValidationGroup="SaveModels"
                     ...
                     <div class="form-group col-md-6">
                        <label class="col-md-3 control-label">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="SaveBus"
                                Display="Dynamic" ErrorMessage="*" ControlToValidate="txt_MaintDate"></asp:RequiredFieldValidator>
                        </label>
                        <div class="col-md-9">
                            <div class="input-group">
                                <asp:TextBox ID="txt_MaintDate" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="form-group col-md-6">
                        <label class="col-md-3 control-label">
                            <asp:Label ID="Label8" runat="server" Text="وصف الاعطال"></asp:Label>
                        </label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group col-md-6">
                        <label class="col-md-3 control-label">
                            <asp:Label ID="Label9" runat="server" Text="الاجراءات"></asp:Label>
                        </label>
                        <div class="col-md-9">
                        ...
                        <asp:TemplateField HeaderText="التصنيف">
                                <ItemTemplate>
                                    <dx:ASPxComboBox ID="ddl_MaterialMainId" runat="server" AutoPostBack="true" 
                                        ...
                                        onselectedindexchanged="ddl_MaterialMainId_SelectedIndexChanged">
