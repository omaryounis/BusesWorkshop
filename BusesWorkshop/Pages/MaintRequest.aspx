<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Master.Master" CodeBehind="MaintRequest.aspx.cs" Inherits="BusesWorkshop.Pages.MaintRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SupPlaceHolder" runat="server">
    ...
    <div class="row">
        ...
        <TabPages>
            <dx:TabPage Text=" طلب الصيانه" Name="BasicData">
                <ContentCollection>
                    <dx:ContentControl>
                          <div class="row">
        <div class="col-md-12">
