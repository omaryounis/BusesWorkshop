<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MaintRequestProcessing.ascx.cs" Inherits="BusesWorkshop.UserControls.MaintRequestProcessing1" %>
...
<!-- Page-Title -->
<div class="row" runat="server" id="PageTitle">
    <div class="col-sm-6">
        <div class="page-title-box text-right">
            <h4 class="page-title">طلبات لم يتم عمل اجراء لها</h4>
        </div>
    </div>
</div>
<!-- end page title end breadcrumb -->
<div class="row" runat="server" id="GRidRec">
    <div class="col-md-12">
        <div class="card-box"> 
            <asp:GridView ID="grd_Requests" runat="server" Visible="false"
                CssClass="table m-0 table-colored table-danger" DataKeyNames="MaintReqId"
...
<div class="row" >
    ...
    <div class="col-sm-6">
        <div class="page-title-box text-right">
            <h4 class="page-title">  الاعمال المطلوبة</h4>
        </div>
    </div>
</div>
<div class="row">
...
<div class="row" runat="server" id="ProcessTitle">
    <div class="col-sm-6">
        <div class="page-title-box text-right">
...
<div class="row"  runat="server" id="Process">
    <div class="col-md-12">
        <div class="card-box">
