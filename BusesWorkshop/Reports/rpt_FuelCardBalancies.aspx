<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Master.Master" CodeBehind="rpt_FuelCardBalancies.aspx.cs" Inherits="BusesWorkshop.Reports.rpt_FuelCardBalancies" %>
...
<dx:ReportToolbar ID="ReportToolbar1" runat='server' ShowDefaultButtons='False' Width="100%" CssClass="report-st" 
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server"  CssClass="report-st-in" Width="100%" 
        Report="<%# new BusesWorkshop.Reports.FuelCardBalancies() %>" 
        ReportName="BusesWorkshop.Reports.FuelCardBalancies">
    </dx:ReportViewer>
</asp:Content>